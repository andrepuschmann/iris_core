 ...
 * \section DESCRIPTION
 *
 * Contains classes for the parameter interface of a module (component
 * or controller). Parameters are adjustable from XML or controller.
 */
...
/** Represents a parameter of a module child class. Will be created by
...
/** An interface to the parameters of a module
 *
 * The ModuleParameters class permits modules to register parameters of different types along with
...
public:
  ...
  /** Called to tell a module that one of its parameters has been reconfigured.
   *
   * \param name Name of the parameter
   */
